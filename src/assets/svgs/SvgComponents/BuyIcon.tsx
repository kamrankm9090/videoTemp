...
function BuyIcon(props: SvgProps) {
  ...
  return (
    <Svg
      ...
      />
      <Path
        d="M17.02 22.72a5.7 5.7 0 01-4.66-2.42.753.753 0 111.23-.87 4.197 4.197 0 007.63-2.42c0-1.35-.66-2.63-1.76-3.42a.751.751 0 11.88-1.22 5.72 5.72 0 012.38 4.64 5.7 5.7 0 01-5.7 5.71z"
        fill={color}
      />
    </Svg>
  );
