...
import { useSocial_FollowUserMutation, useSocial_UnfollowMutation } from "~/graphql/generated";
 ...
 const UserCardItem = memo(({user}: {user: UserType}) => {
    return (
      <VStack
        ...
        <AppImage imageSource={user?.photoUrl ? { uri: user.photoUrl } : undefined} style={styles.avatar} />
